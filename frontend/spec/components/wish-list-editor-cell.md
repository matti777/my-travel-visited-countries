...
- **Upper-right:** [delete button](delete-button.md) (red trash icon). Tooltip: “Click to remove from wish list”.
...
- **Add** button in the upper-right (compact); no delete control.
